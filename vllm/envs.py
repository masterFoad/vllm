...
if TYPE_CHECKING:
    ...
    VLLM_DIFFUSION_GEMMA_STREAMED_GUMBEL_CHUNK: str = ""
    VLLM_DIFFUSION_GEMMA_STREAMED_GUMBEL_SCRATCH_MIB: int = 1024
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_DIFFUSION_GEMMA_STREAMED_GUMBEL_CHUNK": lambda: os.getenv(
        "VLLM_DIFFUSION_GEMMA_STREAMED_GUMBEL_CHUNK", ""
    ),
    "VLLM_DIFFUSION_GEMMA_STREAMED_GUMBEL_SCRATCH_MIB": lambda: int(
        os.getenv("VLLM_DIFFUSION_GEMMA_STREAMED_GUMBEL_SCRATCH_MIB", "1024")
    ),
